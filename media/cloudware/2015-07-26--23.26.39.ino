        ...
        for(int j=0;j<MAX_POINTS;j++)
        {
          	...
          	if(salvos[i].raindrops[j].speed>0)
            {
                ...
                else
                {
                    ...
                    {
                      	float currSpeed=abs(salvos[i].raindrops[j].speed);
                        salvos[i].raindrops[j].color.red=salvos[i].raindrops[j].color.red>0 ? salvos[i].raindrops[j].color.red-currSpeed : 0;
                        salvos[i].raindrops[j].color.green=salvos[i].raindrops[j].color.green>0 ? salvos[i].raindrops[j].color.green-currSpeed : 0;
                        salvos[i].raindrops[j].color.blue=salvos[i].raindrops[j].color.blue>0 ? salvos[i].raindrops[j].color.blue-currSpeed : 0;
