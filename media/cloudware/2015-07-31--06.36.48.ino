...
int lS[9][9]={
		...
		{0,0,192,192,0,192,192,192},
		{0,0,192,0,192,0,192,192},
		{0,192,0,192,0,192,192,0},
  		{192,0,192,0,192,192,0,0},
		{0,192,0,192,0,0,0,0},
		{192,0,192,0,0,0,0,0}
		};
...
int (*letters[10])[9][9] = { &lS, &lA, &lB, &lE, &lF, &lO, &lP, &lR, &lE, &lT };
