          	...
          	if(salvos[i].raindrops[j].speed>0)
            {
                ...
                else
                {
                  	...
                  	else
                    {
                        ...
                        salvos[i].raindrops[j].color.red=salvos[i].raindrops[j].color.red>0 ? salvos[i].raindrops[j].color.red-2 : 0;
                        salvos[i].raindrops[j].color.green=salvos[i].raindrops[j].color.green>0 ? salvos[i].raindrops[j].color.green-2 : 0;
                        salvos[i].raindrops[j].color.blue=salvos[i].raindrops[j].color.blue>0 ? salvos[i].raindrops[j].color.blue-2 : 0;
