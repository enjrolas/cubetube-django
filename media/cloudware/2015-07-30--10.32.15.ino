...
volatile int voxel_coord_x, voxel_coord_y, voxel_coord_z;
volatile int voxel_color_red, voxel_color_green, voxel_color_blue;
//volatile Point voxel_coord;
//volatile Color voxel_color;
...
void LED(int level, int row, int column, unsigned char red, unsigned char green, unsigned char blue){ //****LED Routine****LED Routine****LED Routine****LED Routine
	...
	//The reason for doing this, is so you don't have to memorize a number for each LED, allowing you to use level, row, column
  	...
  	voxel_coord_x=column;
  	voxel_coord_y=level;
  	voxel_coord_z=row;
  	voxel_color_red=red;
  	voxel_color_green=green;
  	voxel_color_blue=blue;
	digitalWrite(7, LOW);
	digitalWrite(7, HIGH);
...
void ISR(){//***MultiPlex BAM***MultiPlex BAM***MultiPlex BAM***MultiPlex BAM***MultiPlex BAM***MultiPlex BAM***MultiPlex BAM
	//digitalWrite(7, HIGH);
  	//cube.background(black); // Initialize all pixels to 'off'
  	cube.setVoxel(voxel_coord_x, voxel_coord_y, voxel_coord_z, Color(voxel_color_red, voxel_color_green, voxel_color_blue));
	cube.show();
}
