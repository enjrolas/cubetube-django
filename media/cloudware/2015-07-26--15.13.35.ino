 ...
 * *****************************/
float phase = 0.0;
float phaseIncrement = 0.001; // Controls the speed of the moving points. Higher == faster
...
void squarral() 
{
    ...
    {
        trailPoints[i].x=trailPoints[i-0].x;
        trailPoints[i].y=trailPoints[i-0].y;
        trailPoints[i].z=trailPoints[i-0].z;
    }
