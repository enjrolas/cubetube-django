...
void setup() {
  ...
  cubeVelocity[0] = 20;//random(70, 100);
...
void updateCube(float deltaSecs) {
  ...
  else if (cubePosition[1] > (8 - cubeSize) && cubeVelocity[1] > 0) {
    cubePosition[1] = (8 - cubeSize) - cubePosition[1] + (8 - cubeSize);
    cubeVelocity[1] = -cubeVelocity[1];
  }
  ...
  else if (cubePosition[2] > (8 - cubeSize) && cubeVelocity[2] > 0) {
    cubePosition[2] = (8 - cubeSize) - cubePosition[2] + (8 - cubeSize);
    cubeVelocity[2] = -cubeVelocity[2];
  }
}
