...
void setup() {
  ...
  cubeVelocity[0] = random(0, 100) / 100;
  cubeVelocity[1] = random(0, 100) / 100;
  cubeVelocity[2] = random(0, 100) / 100;
...
void updateCube(float deltaSecs) {
  cubePosition[0] += cubePosition[0] + (cubeVelocity[0] * deltaSecs);
  cubePosition[1] += cubePosition[1] + (cubeVelocity[1] * deltaSecs);
  cubePosition[2] += cubePosition[2] + (cubeVelocity[2] * deltaSecs);
  
  if (cubePosition[0] <= 0) {
    cubePosition[0] = 0;
    cubeVelocity[0] = -cubeVelocity[0];
  }
  elseif (cubePosition[0] >= 6) {
    cubePosition[0] = 6;
    cubeVelocity[0] = -cubeVelocity[0];
  }
