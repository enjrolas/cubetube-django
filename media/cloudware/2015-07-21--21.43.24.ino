 ...
 * *****************************/
float phase = 0.0;
float phaseIncrement = 0.0045; // Controls the speed of the moving points. Higher == faster
float colorStretch = 0.1; // Higher numbers will produce tighter color bands 
float plasmaBrightness = 0.15;
//float phaseIncrement = 0.050; // Controls the speed of the moving points. Higher == faster
