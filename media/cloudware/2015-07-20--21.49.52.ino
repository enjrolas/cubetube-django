...
void setup() {
  ...
  cubeColor[0] = random(0, 100);
  cubeColor[1] = random(0, 100);
  cubeColor[2] = random(0, 100);
...
void loop() {
  ...
  */
  ...
  Color col(cubeColor[0] * BRIGHTNESS_MAX, cubeColor[1] * BRIGHTNESS_MAX, cubeColor[2] * BRIGHTNESS_MAX);
  for (int x = 0; x < 8; x++) {
    for (int y = 0; y < 8; y++) {
      for (int z = 0; z < 8; z++) {
  ...
  cubeColor[0] = min(100, max(0, cubeColor[0]));
  cubeColor[1] = min(100, max(0, cubeColor[1]));
  cubeColor[2] = min(100, max(0, cubeColor[2]));
