...
void ISR(){//***MultiPlex***
	// Blanking
  	...
  	background(black);
  	Color faded={constrain(voxel_color.red-frameCounter, 0, maxBrightness), constrain(voxel_color.green-frameCounter, 0, maxBrightness), constrain(voxel_color.blue-frameCounter, 0, maxBrightness)};
