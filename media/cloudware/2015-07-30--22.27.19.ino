...
void loop()
{
  ...
  float dilation = fmap(toFloat(p),toFloat(0),toFloat(256),-diameter + 1,1);
  ...
  for(int x = 0; x < maxSize; x++)
  {
   ...
   //     int zm = fmap(z,toFloat(-1),toFloat(1),toFloat(0),toFloat(maxSize-1))+0.5;
      ...
      //    dim = fmap(diameter + dilation - dist,toFloat(0),toFloat(diameter + dilation),toFloat(0.1),toFloat(0.9));
          cube.setVoxel(x, y, z, Color(int(150 * dim),
