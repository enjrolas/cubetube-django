...
float colorStretch = 0.05; // Higher numbers will produce tighter color bands 
...
void zPlasma() {
	...
	for (col = 0; col < cube.size; col++) {
		...
		float color_4 = (tan(distance1 * distance2 * colorStretch))*(2+0.2*cos(distance1 * distance2 * colorStretch)*sin(distance1 * distance2 * colorStretch)) + 2.0 * 0.5;
        //float color_4 = (tan(distance1 * distance2 * colorStretch)) + 2.0 * 0.5;
