        ...
        for(int j=0;j<numDrops;j++) {
            ...
            salvos[i].raindrops[j].raindrop.z=rand()%8;
              ...
              case 0:
                ...
                break;
              case 1:
          		salvos[i].raindrops[j].raindrop.y=3; //salvos[i].raindrops[j].speed>0 ? (cube.size/2)-1 : (cube.size/2)+1;
                break;
              case 2:
          		salvos[i].raindrops[j].raindrop.y=salvos[i].raindrops[j].speed>0 ? 0 : 7;
                break;
            }
