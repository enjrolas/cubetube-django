...
void zPlasma() {
    ...
    Point p1 = {(sin(phase * 1.200) + 1.0) * 4, (sin(phase * 1.310) + 1.0) * 4.0, (sin(phase * 1.380) + 1.0) * 4.0};
	...
	for (col = 0; col < cube.size; col++) {
		...
		float color_4 = (tan(distance1 * distance2 * colorStretch))*(2+0.2*sin(distance1 * distance2 * colorStretch)*cos(distance1 * distance2 * colorStretch)) + 2.0 * 0.5;
