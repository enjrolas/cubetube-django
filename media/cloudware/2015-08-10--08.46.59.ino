...
int lW[8][8]={
		...
		{255,255,  0,  0,  0,255,255,0},
		{255,255,  0,  0,  0,255,255,0},
  		{255,255,  0,223,  0,255,255,0},
		{255,255,223,255,223,255,255,0},
		{255,255,255,223,255,255,255,0},	
		{255,255,223,  0,223,255,255,0},
		{255,255,  0,  0,  0,255,255,0}
		};
...
int (*letters[9])[8][8] = { &lW, &lE, &lR, &lO, &lB, &lE, &lA, &lT, &lS };
