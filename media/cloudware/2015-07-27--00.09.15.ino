          	...
          	if(salvos[i].raindrops[j].speed>0)
            {
                ...
                else
                {
                  	...
                  	else
                    {
                  	...
                  	salvos[i].raindrops[j].color.red=salvos[i].raindrops[j].color.red-=1;
                  	salvos[i].raindrops[j].color.green=salvos[i].raindrops[j].color.green-=1;
                  	salvos[i].raindrops[j].color.blue=salvos[i].raindrops[j].color.blue-=1;
                  	//salvos[i].raindrops[j].color=cube.lerpColor(salvos[i].raindrops[j].color, black, j, salvos[i].raindrops[j].speed, MAX_POINTS);
                }
            }
          	else
