 ...
 * *****************************/
float phase = 0.0;
float phaseIncrement = 0.0068; // Controls the speed of the moving points. Higher == faster
float colorStretch = 0.2; // Higher numbers will produce tighter color bands 
...
void zPlasma() {
    ...
    Point p2 = {(sin(phase * 1.070) + 1.0) * 4, (sin(phase * 2.865) + 1.0) * 4.0, (sin(phase * 1.010) + 1.0) * 4.0};
