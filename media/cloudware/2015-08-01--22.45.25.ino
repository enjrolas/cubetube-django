...
void setup(){
	...
	attachInterrupt(REFRESH_CONTROL, ISR, CHANGE);
  	tone(REFRESH_CONTROL, 800, 0);	// Sets our refresh rate to 1.8KHz
  	initCloudButton();
...
void ISR(){//***MultiPlex***
	// Blanking
	  ...
	  Color faded=lerpColor(voxel_color, black, addr, addr, blankingIndex);
      strip.setPixelColor(blankingIndex, strip.Color(voxel_color.red, voxel_color.green, voxel_color.blue));
    }
	// Drawing drop
