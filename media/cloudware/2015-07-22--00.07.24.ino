...
char* vizName="SoundBalloon BRIGHT MultiColor";
int vizId=634;
#include <math.h>
...
void loop() {
  ...
  //the signal jumps in amplitude
	...
	cube.shell(cube.center, map(runningAverage, 0, maxAmplitude, 0, cube.size*3/4), Color(0,0,map(runningAverage,0,maxAmplitude,30,150)));
