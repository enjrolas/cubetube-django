...
void setup() {
  ...
  cubeVelocity[0] = random(0, 100);
  cubeVelocity[1] = random(0, 100);
  cubeVelocity[2] = random(0, 100);
  float mag = sqrt(cubeVelocity[0] * cubeVelocity[0] + cubeVelocity[1] * cubeVelocity[1] + cubeVelocity[2] * cubeVelocity[2]);
  cubeVelocity[0] = (cubeVelocity[0] / mag) * cubeSpeed;
  cubeVelocity[1] = (cubeVelocity[1] / mag) * cubeSpeed;
  cubeVelocity[2] = (cubeVelocity[2] / mag) * cubeSpeed;
  
  cubePosition[0] = random(0, 8 - cubeSize);
  cubePosition[1] = random(0, 8 - cubeSize);
  cubePosition[2] = random(0, 8 - cubeSize);
...
void loop() {
  ...
  Color col(r,g,b);
  drawCube(floor(cubePosition[0]), floor(cubePosition[1]), floor(cubePosition[2]), cubeSize, col);
...
void updateCube(float deltaSecs) {
  ...
  else if (cubePosition[0] >= (9 - cubeSize) && cubeVelocity[0] > 0) {
    cubePosition[0] = (9 - cubeSize) - cubePosition[0] + (9 - cubeSize);
    cubeVelocity[0] = -cubeVelocity[0];
  }
  ...
  else if (cubePosition[1] >= (9 - cubeSize) && cubeVelocity[1] > 0) {
    cubePosition[1] = (9 - cubeSize) - cubePosition[1] + (9 - cubeSize);
    cubeVelocity[1] = -cubeVelocity[1];
  }
  ...
  else if (cubePosition[2] >= (9 - cubeSize) && cubeVelocity[2] > 0) {
    cubePosition[2] = (9 - cubeSize) - cubePosition[2] + (9 - cubeSize);
    cubeVelocity[2] = -cubeVelocity[2];
  }
}
