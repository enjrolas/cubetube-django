...
void setup() {
  ...
  cubeVelocity[0] = 1;//random(70, 100);
...
void updateCube(float deltaSecs) {
  ...
  if (floor(cubePosition[0]) <= 0 && cubeVelocity[0] < 0) {
    cubePosition[0] = 0;
    cubeVelocity[0] = -cubeVelocity[0];
  }
  else if (floor(cubePosition[0]) >= 7 && cubeVelocity[0] > 0) {
    cubePosition[0] = 7;
    cubeVelocity[0] = -cubeVelocity[0];
  }
  
  if (floor(cubePosition[1]) <= 0 && cubeVelocity[1] < 0) {
  ...
  if (floor(cubePosition[2]) <= 0 && cubeVelocity[2] < 0) {
