 ...
 * *****************************/
float phase = 0.0;
float phaseIncrement = 0.0075; // Controls the speed of the moving points. Higher == faster
...
void zPlasma() {
	...
	for (col = 0; col < cube.size; col++) {
		...
		float color_4 = (tan(distance1 * distance2 * colorStretch))*(0+sin(distance1 * distance2 )*cos(distance1 * distance2));
