...
void loop() {
  ...
  //the signal jumps in amplitude
	...
	cube.shell(cube.center, map(runningAverage, 0, maxAmplitude, 0, 7), Color(map(runningAverage,0,maxAmplitude,0,255),random(256),random(256)));
//	cube.shell(cube.center, map(runningAverage, 0, maxAmplitude, 0, cube.size*3/4), Color(map(runningAverage,0,maxAmplitude,0,255),random(256),random(256)));
//	cube.shell(cube.center, map(runningAverage, 0, maxAmplitude, 0, cube.size*3/4), Color(map(runningAverage,0,maxAmplitude,0,255),random(256),random(256)));
