    ...
    for(int i=0;i<cube.size;i++)
    {
        ...
        for(int j=0;j<MAX_POINTS;j++)
        {
          	...
          	if(newSpeed>0)
            {
                ...
                {
                  	newSpeed=setNewSpeed();	//-newSpeed;
                    //salvos[i].raindrops[j].x=-1;
                    //salvos[i].raindrops[j].z=-1;
                }
        }
        //if you found this "raining up'n'down" thing became way
        //too crazy for you, just comment out the next line
        //to "bring rain back". I'm going to work on smoothening
      	//out the transitions so that I hope it'll look better
      	//setNewSpeed();
