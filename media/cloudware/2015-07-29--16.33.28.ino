            ...
            for(int j=0;j<MAX_POINTS;j++)
              	if(!salvos[i].raindrops[j].dead){
                	...
                	if(salvos[i].raindrops[j].speed>0)
                      	cube.setVoxel(salvos[i].raindrops[j].raindrop.x, salvos[i].raindrops[j].raindrop.y-1, salvos[i].raindrops[j].raindrop.z, cube.lerpColor(salvos[i].raindrops[j].color, black, abs(j-i), abs(salvos[i].raindrops[j].speed), fadingMax));
                	else
                      	cube.setVoxel(salvos[i].raindrops[j].raindrop.x, salvos[i].raindrops[j].raindrop.y+1, salvos[i].raindrops[j].raindrop.z, cube.lerpColor(salvos[i].raindrops[j].color, black, abs(j-i), abs(salvos[i].raindrops[j].speed), fadingMax));
                }
}
