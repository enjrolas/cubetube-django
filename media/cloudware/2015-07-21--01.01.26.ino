...
char* vizName="Twinkling";
int vizId=120;
// Credit Mark Kriegsman, by permission
// Disclaimer: this code is intended to be exploratory, not exemplary
#include "FastLED.h"
...
//  Twinkling lights that fade up and down in brightness.
