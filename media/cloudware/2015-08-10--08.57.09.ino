...
int lW[8][8]={
		{255,255,  0,  0,  0,255,223,0},
		{255,255,  0,  0,  0,255,223,0},
		{255,255,  0,  0,  0,255,223,0},
  		{255,255,  0,255,  0,255,223,0},
		{255,255,255,255,255,255,223,0},
		{255,255,255,223,255,255,223,0},	
		{255,255,223,  0,255,255,223,0},
		{223,223,  0,  0,  0,223,223,0}
		};

int lE[8][8]={
		{0,  0,255,255,255,255,223,0},
		{0,255,223,223,223,223,223,0},
		{0,255,255,  0,  0,  0,  0,0},
  		{0,255,255,255,223,  0,  0,0},
		{0,255,223,223,223,  0,  0,0},
        {0,255,255,  0,  0,  0,  0,0},
		{0,255,255,255,255,255,223,0},
		{0,  0,223,223,223,223,223,0}
		};
...
int (*letters[9])[8][8] = { &lW, &lE, &lL, &lO, &lB, &lE, &lA, &lT, &lS };
