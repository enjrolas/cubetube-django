...
void updateSalvos()
{
    for(int i=0;i<cube.size;i++)
    {
        ...
        for(int j=0;j<MAX_POINTS;j++)
        {
            salvos[i].raindrops[j].raindrop.y+=salvos[i].raindrops[j].speed;	//newSpeed;	//SPEED;
          	if(salvos[i].raindrops[j].speed>0)
            {
                ...
                else
                {
                    ...
                    {
                        int dimCoeff= cube.size+(MAX_POINTS/(salvos[i].raindrops[j].raindrop.y+1));
                        salvos[i].raindrops[j].color.red= (salvos[i].raindrops[j].color.red>dimCoeff) ? salvos[i].raindrops[j].color.red-dimCoeff : 0;
                        salvos[i].raindrops[j].color.green= (salvos[i].raindrops[j].color.green>dimCoeff) ? salvos[i].raindrops[j].color.green-dimCoeff : 0;
                        salvos[i].raindrops[j].color.blue= (salvos[i].raindrops[j].color.blue>dimCoeff) ? salvos[i].raindrops[j].color.blue-dimCoeff : 0;
                        //salvos[i].raindrops[j].color.red=salvos[i].raindrops[j].color.red*(salvos[i].raindrops[j].raindrop.y-cube.size)/(cube.size-1);
                        //salvos[i].raindrops[j].color.green=salvos[i].raindrops[j].color.green*(salvos[i].raindrops[j].raindrop.y-cube.size)/(cube.size-1);
                        //salvos[i].raindrops[j].color.blue=salvos[i].raindrops[j].color.blue*(salvos[i].raindrops[j].raindrop.y-cube.size)/(cube.size-1);
                ...
                else
                {
                    ...
                    {
                        salvos[i].raindrops[j].color.red=salvos[i].raindrops[j].color.red*(cube.size-salvos[i].raindrops[j].raindrop.y)/(cube.size-1);
                        salvos[i].raindrops[j].color.green=salvos[i].raindrops[j].color.green*(cube.size-salvos[i].raindrops[j].raindrop.y)/(cube.size-1);
                        salvos[i].raindrops[j].color.blue=salvos[i].raindrops[j].color.blue*(cube.size-salvos[i].raindrops[j].raindrop.y)/(cube.size-1);
