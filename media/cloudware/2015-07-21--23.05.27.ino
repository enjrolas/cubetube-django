...
char* vizName="       FFT Meteors Rainbow";
int vizId=664;
// FFT_Meteors_Rainbow
...
bool  smoothLEDs=false;	//switch for 'smoothening-out' the LEDs fade-to-black on the spectrum
bool  dotMode=false;		//switch to control the peak indication over each strip (bar/dot)
//float sample;
