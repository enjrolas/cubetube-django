              	...
              	if(!salvos[i].raindrops[j].dead){
                	cube.setVoxel(salvos[i].raindrops[j].raindrop.x, salvos[i].raindrops[j].raindrop.y, salvos[i].raindrops[j].raindrop.z, salvos[i].raindrops[j].color);
                  	...
                  	if(salvos[i].raindrops[j].speed>0)
                      	cube.setVoxel(salvos[i].raindrops[j].raindrop.x, salvos[i].raindrops[j].raindrop.y-1, salvos[i].raindrops[j].raindrop.z, Color(salvos[i].raindrops[j].color.red--, salvos[i].raindrops[j].color.green--, salvos[i].raindrops[j].color.blue--));
                	else
                      	cube.setVoxel(salvos[i].raindrops[j].raindrop.x, salvos[i].raindrops[j].raindrop.y+1, salvos[i].raindrops[j].raindrop.z, Color(salvos[i].raindrops[j].color.red--, salvos[i].raindrops[j].color.green--, salvos[i].raindrops[j].color.blue--));
                }
}
