...
def viz_flashed(request):
    ...
    startDate = datetime.datetime.strptime(datetime.date(today.year, int(month), 1),"%Y-%m-%d").date()
    endDate = datetime.datetime.strptime(datetime.date(next_year, next_month, 1),"%Y-%m-%d").date()
