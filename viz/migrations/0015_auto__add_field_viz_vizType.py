...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Viz.vizType'
        db.add_column(u'viz_viz', 'vizType',
                      self.gf('django.db.models.fields.TextField')(default='spark'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Viz.vizType'
        db.delete_column(u'viz_viz', 'vizType')
