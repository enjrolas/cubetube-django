			...
			var cardsPerRow = window.innerWidth > 1300 ? 4 : 3;
	  		switch(button) {
				case "all":
					...
					$('#viz-cards').animate({height: (vizCardHeight+(cardsPerRow === 4 ? 25 : 40))*totalRows}, 1200);
				...
				case "back":
					...
					$('#viz-cards').height(vizGalleryHeight)
			  		$('#viz-cards').animate({height: "+=" + (vizCardHeight+(cardsPerRow === 4 ? 25 : 40))*totalRows}, 800, "linear");
