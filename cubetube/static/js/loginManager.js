...
function hideMenuItems() {
    ...
    $($("ul.items > li").get().reverse()).each(function (index) {
        if (!$(this).hasClass("sole-button"))
            $(this).stop(true).delay(200 * index).addClass('on-overview').delay(150 * index).slideUp(800, "linear", function () {
                $(this).delay(150 * index).removeClass('on-overview');
            });
    });
}
    ...
    if (!clicks) {
        ...
        $('ul.items > li').each(function (index) {
            if (!$(this).hasClass("sole-button")) {
                ...
                if ($(this).next().length)
                    $(this).stop(true).delay(150 * index).slideDown(800, "linear", function () {
                        $(this).stop(true).delay(150 * index).removeClass('on-overview');
                    });
                else
                    $(this).stop(true).delay(150 * index).slideDown(800, "linear");
            }
        });
    }
}
